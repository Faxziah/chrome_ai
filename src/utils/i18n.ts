...
const translations: LocaleData = {
  en: {
    ...
    'api.keyNotSet': 'Please set your Gemini API key by clicking on the extension icon in the browser toolbar, then refresh the page. You can change the language in the extension settings.',
  ...
  ru: {
    ...
    'api.keyNotSet': 'Установите Gemini API-ключ, для этого нажмите на иконку расширения в панели браузера, затем обновите страницу. Вы можете изменить язык в параметрах расширения.',
  ...
  de: {
    ...
    'api.keyNotSet': 'Bitte setzen Sie Ihren Gemini API-Schlüssel, indem Sie auf das Erweiterungssymbol in der Browser-Symbolleiste klicken, dann aktualisieren Sie die Seite. Sie können die Sprache in den Erweiterungseinstellungen ändern.',
  ...
  fr: {
    ...
    'api.keyNotSet': 'Veuillez définir votre clé API Gemini en cliquant sur l\'icône d\'extension dans la barre d\'outils du navigateur, puis actualisez la page. Vous pouvez changer la langue dans les paramètres de l\'extension.',
  ...
  zh: {
    ...
    'api.keyNotSet': '请通过点击浏览器工具栏中的扩展图标来设置您的Gemini API密钥，然后刷新页面。您可以在扩展设置中更改语言。',
